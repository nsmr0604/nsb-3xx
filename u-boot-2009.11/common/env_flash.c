...
int  env_init(void)
{
	...
	if ((gs2 & 0x80)==0) {	/* boot from u-boot 0 */
		env_ptr = (env_t *)(CONFIG_FLASH_PART_BOOTENV0_LOC);
		flash_addr = (env_t *)(CONFIG_FLASH_PART_BOOTENV0_LOC);
	}
	else {	/* boot from u-boot 1 */
		env_ptr = (env_t *)(CONFIG_FLASH_PART_BOOTENV1_LOC);
		flash_addr = (env_t *)(CONFIG_FLASH_PART_BOOTENV1_LOC);
	}
