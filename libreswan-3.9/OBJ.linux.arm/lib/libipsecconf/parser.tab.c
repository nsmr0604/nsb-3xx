...
/* Line 189 of yacc.c  */
#line 1 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
   /* -*- bison-mode -*- */
...
/* Line 214 of yacc.c  */
#line 61 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
...
{
       0,     0,     3,     8,    11,    12,    16,    20,    21,    24,
      28,    29,    32,    33,    39,    40,    46,    50,    53,    54,
...
{
      20,     0,    -1,    22,    21,    22,    23,    -1,    22,    23,
      -1,    -1,    10,    11,     5,    -1,    10,    12,     5,    -1,
      -1,    22,     5,    -1,    22,     4,     5,    -1,    -1,    23,
      24,    -1,    -1,     6,     7,     5,    25,    27,    -1,    -1,
       8,    11,     5,    26,    27,    -1,     9,    11,     5,    -1,
      27,    28,    -1,    -1,     4,    29,     5,    -1,    14,     3,
      14,    -1,    18,     3,    11,    -1,    14,     3,    11,    -1,
      16,     3,    13,    -1,    14,     3,    12,    -1,    15,     3,
      11,    -1,    17,     3,    11,    -1,    14,     3,    13,    -1,
      14,     3,    -1
};
...
{
       0,    82,    82,    83,    89,    90,    91,    94,    95,    96,
      99,   100,   104,   104,   111,   111,   138,   144,   145,   148,
     151,   214,   227,   287,   305,   323,   378,   428,   446
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SETUP", "CONN", "INCLUDE", "VERSION", "STRING", "INTEGER", "BOOL",
  "KEYWORD", "TIMEWORD", "BOOLWORD", "PERCENTWORD", "COMMENT", "$accept",
  "config_file", "versionstmt", "blanklines", "sections",
  "section_or_include", "$@1", "$@2", "kw_sections", "kw_section",
  "statement_kw", 0
};
#endif
...
{
       7,     0,     4,     1,     0,     8,     0,     7,     3,     9,
       0,     0,    10,     0,     0,     0,    11,     5,     6,     2,
       0,     0,     0,    12,    14,    16,    18,    18,    13,    15,
       0,    17,     0,     0,     0,     0,     0,     0,    28,     0,
       0,     0,     0,    19,    22,    24,    27,    20,    25,    23,
      26,    21
};
...
{
     -10,    13,    -4,   -10,    15,   -10,     5,   -10,     6,   -10,
      16,    17,    14,    18,    12,    19,   -10,   -10,   -10,     6,
      21,    22,    23,   -10,   -10,   -10,   -10,   -10,    20,    20,
      -7,   -10,    26,    28,    29,    30,    31,    32,    -9,    24,
      25,    33,    34,   -10,   -10,   -10,   -10,   -10,   -10,   -10,
     -10,   -10
};
...
{
       4,     5,    44,    45,    46,    47,     6,    32,    33,    34,
      35,    36,    13,     3,    14,    15,    10,    11,     4,     5,
       9,    17,    18,    21,    30,    20,    23,    24,    25,    38,
      22,    39,    40,    41,    42,    48,    29,    43,    49,    19,
       0,     0,    12,     0,    50,    51
};

static const yytype_int8 yycheck[] =
{
       4,     5,    11,    12,    13,    14,    10,    14,    15,    16,
      17,    18,     6,     0,     8,     9,    11,    12,     4,     5,
       5,     5,     5,    11,     4,     7,     5,     5,     5,     3,
      11,     3,     3,     3,     3,    11,    27,     5,    13,    12,
      -1,    -1,     7,    -1,    11,    11
};
...
{
       0,    20,    22,     0,     4,     5,    10,    21,    23,     5,
      11,    12,    22,     6,     8,     9,    24,     5,     5,    23,
       7,    11,    11,     5,     5,     5,    25,    26,    27,    27,
       4,    28,    14,    15,    16,    17,    18,    29,     3,     3,
       3,     3,     3,     5,    11,    12,    13,    14,    11,    13,
      11,    11
};
...
/* Line 1464 of yacc.c  */
#line 104 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
    {
...
/* Line 1464 of yacc.c  */
#line 111 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
    {
		struct section_list *section;
		section = (struct section_list *)malloc(sizeof(struct section_list));
		if (section) {

			section->name = (yyvsp[(2) - (3)].s);
			section->kw = NULL;
...
/* Line 1464 of yacc.c  */
#line 138 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
    {
 		parser_y_include((yyvsp[(2) - (3)].s));
	;}
    break;
...
/* Line 1464 of yacc.c  */
#line 151 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
    {
		struct kw_list *new;
		...
		if (!new) {
		    ...
		    struct keyword kw;
	            ...
	            const char *value = (yyvsp[(3) - (3)].k).keydef->keyname;
...
/* Line 1464 of yacc.c  */
#line 214 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
    {
		struct starter_comments *new;

		new = alloc_comment();
		if (new) {
		    new->x_comment = strdup((yyvsp[(1) - (3)].k).string);
		    new->commentvalue = strdup((yyvsp[(3) - (3)].s));
...
/* Line 1464 of yacc.c  */
#line 227 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
    {
		struct kw_list *new;
		...
		if (!new) {
		    ...
		    switch(kw.keydef->type) {
		    case kt_list:
			new->number = parser_enum_list(kw.keydef, (yyvsp[(3) - (3)].s), TRUE);
			break;
	            case kt_enum:
			new->number = parser_enum_list(kw.keydef, (yyvsp[(3) - (3)].s), FALSE);
			break;
		    case kt_rsakey:
		    case kt_loose_enum:
			new->number = parser_loose_enum(&new->keyword, (yyvsp[(3) - (3)].s));
                        break;
		    case kt_string:
		    case kt_appendstring:
		    case kt_appendlist:
...
/* Line 1464 of yacc.c  */
#line 287 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
    {
		struct kw_list *new;
		...
		new = alloc_kwlist();
		if (new) {
		    new->keyword = (yyvsp[(1) - (3)].k);
		    new->number = (yyvsp[(3) - (3)].num);  /* Should not be necessary! */
		    new->next = NULL;
		    if (_parser_kw_last)
			_parser_kw_last->next = new;
		    _parser_kw_last = new;
...
/* Line 1464 of yacc.c  */
#line 305 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
    {
		struct kw_list *new;
...
/* Line 1464 of yacc.c  */
#line 323 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
    {
		struct kw_list *new;
		char *endptr, *str;
                unsigned int val;
		struct keyword kw = (yyvsp[(1) - (3)].k);
		bool fail;
                char buf[80];
...
/* Line 1464 of yacc.c  */
#line 378 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
    {
		struct kw_list *new;
		char *endptr, *str;
		struct keyword kw = (yyvsp[(1) - (3)].k);
...
/* Line 1464 of yacc.c  */
#line 428 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
    {
		struct kw_list *new;
...
/* Line 1464 of yacc.c  */
#line 446 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
    { /* this is meaningless, we ignore it */ ;}
    break;
...
/* Line 1684 of yacc.c  */
#line 449 "/home/igarashi/cortina/build_dir/linux-g2_wan/libreswan-3.9/lib/libipsecconf/parser.y"
