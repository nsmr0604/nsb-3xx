...
case "$perladmin" in
'') perladmin='igarashi@igarashi-virtualbox.soarsystem.local' ;;
esac
...
# archlib='/usr/local/lib/perl5/5.10.0/i686-linux'
...
# sitearch='/usr/local/lib/perl5/site_perl/5.10.0/i686-linux'
