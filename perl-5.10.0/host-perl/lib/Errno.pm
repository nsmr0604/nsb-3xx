...
"i686-linux-2.6.38-16-generic" or
	die "Errno architecture (i686-linux-2.6.38-16-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
