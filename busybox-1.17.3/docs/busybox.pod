...
Currently available applets include:
	...
	[, [[, addgroup, adduser, arp, arping, ash, awk, basename, beep,
	blkid, bunzip2, bzcat, cat, chgrp, chmod, chown, chroot, chrt,
	clear, cmp, cp, crond, crontab, cut, date, dd, delgroup, deluser,
	depmod, df, dhcprelay, diff, dirname, dmesg, du, dumpleases, echo,
	egrep, env, expr, false, fdisk, fgrep, find, free, fsck, ftpd,
	ftpget, ftpput, getty, grep, gunzip, gzip, halt, hd, hdparm, head,
	hexdump, hostid, hwclock, id, ifconfig, init, insmod, kill, killall,
	killall5, klogd, length, less, ln, lock, logger, login, logread, ls,
	lsmod, lspci, lsusb, md5sum, mesg, mkdir, mkdosfs, mke2fs, mkfifo,
	mkfs.ext2, mkfs.minix, mkfs.reiser, mkfs.vfat, mknod, mkswap,
	mktemp, modprobe, more, mount, mv, nc, netmsg, netstat, nice, nohup,
	nslookup, passwd, pgrep, pidof, ping, ping6, pivot_root, pkill,
	poweroff, printf, ps, pwd, reboot, renice, reset, resize, rm, rmdir,
	rmmod, route, rtcwake, sed, seq, sh, sleep, sort, start-stop-daemon,
	strings, swapoff, swapon, switch_root, sync, sysctl, syslogd, tail,
	tar, taskset, tee, telnet, telnetd, test, tftp, time, top, touch,
	tr, traceroute, true, tty, tune2fs, udhcpc, udhcpd, umount, uname,
	uniq, uptime, usleep, vconfig, vi, watchdog, wc, wget, which, xargs,
	yes, zcat
...
modprobe [-alrqvsb] MODULE [symbol=value]...
...
tar -[cxtzvO] [-X FILE] [-f TARFILE] [-C DIR] [FILE]...
