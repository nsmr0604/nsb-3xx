...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all notification messages
      > print /files/usr/etc/upsmon.conf/NOTIFYMSG

About: Configuration files
  This lens applies to /usr/etc/upsmon.conf. See <filter>.
*)
...
let upsmon_filter = ( incl "/usr/etc/upsmon.conf" )
			. Util.stdexcl
