...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print the string declaring secured cgi directory:
      > print /files/usr/etc/upsset.conf/auth

About: Configuration files
  This lens applies to /usr/etc/upsset.conf. See <filter>.
*)
...
let upsset_filter = ( incl "/usr/etc/upsset.conf" )
                        . Util.stdexcl
