...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print the command script:
      > print /files/usr/etc/upssched.conf/CMDSCRIPT

About: Configuration files
  This lens applies to /usr/etc/upssched.conf. See <filter>.
*)
...
let upssched_filter = ( incl "/usr/etc/upssched.conf" )
			. Util.stdexcl
