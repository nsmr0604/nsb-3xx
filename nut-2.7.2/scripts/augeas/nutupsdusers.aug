...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all users granted to send commands to UPS
      > /files/usr/etc/upsd.users/fred/actions/SET

About: Configuration files
  This lens applies to /usr/etc/upsd.users. See <filter>.
*)
...
let upsd_users_filter = ( incl "/usr/etc/upsd.users" )
			. Util.stdexcl
