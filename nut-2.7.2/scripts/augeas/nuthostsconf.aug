...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all monitored upsd
	> print /files/usr/etc/hosts.conf/MONITOR

About: Configuration files
  This lens applies to /usr/etc/hosts.conf. See <filter>.
*)
...
let hosts_filter = ( incl "/usr/etc/hosts.conf" )
                        . Util.stdexcl
