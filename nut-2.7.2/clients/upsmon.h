...
#define ST_LOWBATT_DOWN	(1 << 7)	/* UPS detect low battery */
...
#define NOTIFY_LOWBATT_DOWN	10	/* Detect low battery	*/
...
}	notifylist[] =
{
	...
	{ NOTIFY_LOWBATT_DOWN, "LOWBATT_DOWN", NULL, "LOWBATT_DOWN UPS %s DOWN", 0 },
	{ 0, NULL, NULL, NULL, 0 }
};
