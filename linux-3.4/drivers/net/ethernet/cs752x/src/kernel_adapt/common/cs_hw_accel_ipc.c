...
struct g2_ipc_msg cs_pe_ipc_procs[] = {
	...
	{CS_ETHERIP_IPC_PE_SET_ENTRY_ACK, (unsigned long) cs_etherip_ipc_rcv_set_entry_ack},
	{CS_ETHERIP_IPC_PE_DEL_ENTRY_ACK, (unsigned long) cs_etherip_ipc_rcv_del_entry_ack},
