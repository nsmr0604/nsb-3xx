...
int __init cs_accel_mgr_init_module(void)
{
	...
	if (cs_kernel_mod_hw_accel_enable & CS752X_ADAPT_ENABLE_IPV4_MULTICAST) {
		cs_core_vtable_set_entry_valid(CORE_VTABLE_TYPE_L3_MCAST_V4, 1);
		cs_core_vtable_set_entry_valid(CORE_VTABLE_TYPE_L3_MCAST_V4_CTRL, 0);
	} else {
		cs_core_vtable_set_entry_valid(CORE_VTABLE_TYPE_L3_MCAST_V4, 0);
		cs_core_vtable_set_entry_valid(CORE_VTABLE_TYPE_L3_MCAST_V4_CTRL, 1);
	}

	if (cs_kernel_mod_hw_accel_enable & CS752X_ADAPT_ENABLE_IPV6_MULTICAST) {
		cs_core_vtable_set_entry_valid(CORE_VTABLE_TYPE_L3_MCAST_V6, 1);
		cs_core_vtable_set_entry_valid(CORE_VTABLE_TYPE_L3_MCAST_V6_CTRL, 0);
	} else {
		cs_core_vtable_set_entry_valid(CORE_VTABLE_TYPE_L3_MCAST_V6, 0);
		cs_core_vtable_set_entry_valid(CORE_VTABLE_TYPE_L3_MCAST_V6_CTRL, 1);
	}
