...
cs_status_t cs_flow_add(CS_IN cs_dev_id_t device_id, CS_IN_OUT cs_flow_t *p_flow)
{
	...
	switch (p_flow->flow_type) {
		...
		case CS_FLOW_TYPE_MC_MEMBER:
			...
			break;
		case CS_FLOW_TYPE_L2_DA_SA:
			rule_hash.apptype = CORE_FWD_APP_TYPE_L2_FLOW_DA_SA;
			break;
		default:
	...
	if (rule_hash.apptype != CORE_FWD_APP_TYPE_L2_FLOW && rule_hash.apptype != CORE_FWD_APP_TYPE_L2_FLOW_DA_SA) {
