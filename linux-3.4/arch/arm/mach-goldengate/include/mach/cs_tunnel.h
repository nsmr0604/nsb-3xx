...
typedef struct cs_etherip_tunnel_cfg_s {
	...
	cs_l3_ip_addr		tun_saddr;		/* Outer IP addr */
	cs_l3_ip_addr		tun_daddr;		/* Outer IP addr */
	cs_uint32_t		ipsec_policy;		/* 0: unused, otherwise: encrypted */
} cs_etherip_tunnel_cfg_t;

typedef union cs_tunnel_cfg_union_s {
	cs_l2tp_tunnel_cfg_t	l2tp;
	cs_gre_tunnel_cfg_t	gre;
	cs_ipsec_tunnel_cfg_t	ipsec;
	cs_etherip_tunnel_cfg_t etherip;
