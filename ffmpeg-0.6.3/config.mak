...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target_os=linux --enable-cross-compile --cross-prefix=arm-openwrt-linux-uclibcgnueabi- --arch=arm --prefix=/usr --enable-shared --enable-static --disable-debug --enable-gpl --disable-libfaad --disable-mmx --disable-mmx2 --enable-pthreads --disable-optimizations --enable-small --disable-stripping --enable-zlib --enable-postproc --enable-swscale --enable-libfaac --enable-libx264 --enable-nonfree --disable-ffmpeg --disable-ffserver --enable-bsfs --enable-encoders --enable-decoders --enable-muxers --enable-demuxers --enable-parsers --enable-protocols
prefix=/usr
...
SRC_PATH="/home/igarashi/cortina/build_dir/target-arm_uClibc-0.9.32_eabi/ffmpeg-0.6.3"
SRC_PATH_BARE=/home/igarashi/cortina/build_dir/target-arm_uClibc-0.9.32_eabi/ffmpeg-0.6.3
BUILD_ROOT="/home/igarashi/cortina/build_dir/target-arm_uClibc-0.9.32_eabi/ffmpeg-0.6.3"
ARCH=arm
CC=arm-openwrt-linux-uclibcgnueabi-gcc
AS=arm-openwrt-linux-uclibcgnueabi-gcc
LD=arm-openwrt-linux-uclibcgnueabi-gcc
DEPCC=arm-openwrt-linux-uclibcgnueabi-gcc
YASM=yasm
YASMDEP=yasm
...
CFLAGS=-O -pipe -march=armv7-a -mtune=cortex-a9 -funit-at-a-time -mfpu=neon -ftree-vectorize -mfloat-abi=softfp -fhonour-copts -I/home/igarashi/cortina/staging_dir/target-arm_uClibc-0.9.32_eabi/usr/include -I/home/igarashi/cortina/staging_dir/target-arm_uClibc-0.9.32_eabi/include -I/home/igarashi/cortina/staging_dir/toolchain-arm_gcc-4.5.1+l_uClibc-0.9.32_eabi/usr/include -I/home/igarashi/cortina/staging_dir/toolchain-arm_gcc-4.5.1+l_uClibc-0.9.32_eabi/include -fpic   -std=c99 -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit -Werror=missing-prototypes
ASFLAGS=-O -pipe -march=armv7-a -mtune=cortex-a9 -funit-at-a-time -mfpu=neon -ftree-vectorize -mfloat-abi=softfp -fhonour-copts   -fPIC
CC_O=-o $@
DLLTOOL=
LDFLAGS= -L/home/igarashi/cortina/staging_dir/target-arm_uClibc-0.9.32_eabi/usr/lib -L/home/igarashi/cortina/staging_dir/target-arm_uClibc-0.9.32_eabi/lib -L/home/igarashi/cortina/staging_dir/toolchain-arm_gcc-4.5.1+l_uClibc-0.9.32_eabi/usr/lib -L/home/igarashi/cortina/staging_dir/toolchain-arm_gcc-4.5.1+l_uClibc-0.9.32_eabi/lib -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
...
EXTRALIBS=  -lz -pthread -lm -lfaac -lx264 -lm
INSTALL=install
LIBTARGET=
